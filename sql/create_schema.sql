...
CREATE TABLE
    IF NOT EXISTS market.cc_asset_coin_uid_map (
        asset_id BIGINT NOT NULL,
        symbol VARCHAR(255) CHARACTER
        SET
            utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
            coin_uid VARCHAR(256) CHARACTER
        SET
...
CREATE TABLE
    market.cc_futures_open_interest_ohlc_1m (
        datetime DATETIME NOT NULL,
        market VARCHAR(255) NOT NULL,
        instrument VARCHAR(255) NOT NULL,
        mapped_instrument VARCHAR(255),
...
CREATE TABLE
    market.cc_futures_open_interest_ohlc_1h (
        datetime DATETIME NOT NULL,
        market VARCHAR(255) NOT NULL,
        instrument VARCHAR(255) NOT NULL,
        mapped_instrument VARCHAR(255),
...
CREATE TABLE
    market.cc_futures_open_interest_ohlc_1d (
        datetime DATETIME NOT NULL,
        market VARCHAR(255) NOT NULL,
        instrument VARCHAR(255) NOT NULL,
        mapped_instrument VARCHAR(255),
...
CREATE TABLE
    market.cc_futures_funding_rate_ohlc_1m (
        datetime DATETIME NOT NULL,
        market VARCHAR(255) NOT NULL,
        instrument VARCHAR(255) NOT NULL,
        mapped_instrument VARCHAR(255),
...
CREATE TABLE
    market.cc_futures_funding_rate_ohlc_1h (
        datetime DATETIME NOT NULL,
        market VARCHAR(255) NOT NULL,
        instrument VARCHAR(255) NOT NULL,
        mapped_instrument VARCHAR(255),
...
CREATE TABLE
    market.cc_futures_funding_rate_ohlc_1d (
        datetime DATETIME NOT NULL,
        market VARCHAR(255) NOT NULL,
        instrument VARCHAR(255) NOT NULL,
        mapped_instrument VARCHAR(255),
