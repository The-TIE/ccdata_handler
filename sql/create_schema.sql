...
CREATE TABLE market.cc_futures_ohlcv_1m (
    datetime DATETIME NOT NULL,
    market VARCHAR(255) NOT NULL,
...
CREATE TABLE market.cc_futures_ohlcv_1h (
    datetime DATETIME NOT NULL,
    market VARCHAR(255) NOT NULL,
    instrument VARCHAR(255) NOT NULL,
    mapped_instrument VARCHAR(255),
...
CREATE TABLE market.cc_futures_ohlcv_1d (
    datetime DATETIME NOT NULL,
    market VARCHAR(255) NOT NULL,
    instrument VARCHAR(255) NOT NULL,
    mapped_instrument VARCHAR(255),
...
-- === Futures Open Interest OHLC Tables ===

CREATE TABLE market.cc_futures_open_interest_ohlc_1m (
    datetime DATETIME NOT NULL,
    market VARCHAR(255) NOT NULL,
    instrument VARCHAR(255) NOT NULL,
    mapped_instrument VARCHAR(255),
...
CREATE TABLE market.cc_futures_open_interest_ohlc_1h (
    datetime DATETIME NOT NULL,
    market VARCHAR(255) NOT NULL,
    instrument VARCHAR(255) NOT NULL,
    mapped_instrument VARCHAR(255),
...
CREATE TABLE market.cc_futures_open_interest_ohlc_1d (
    datetime DATETIME NOT NULL,
    market VARCHAR(255) NOT NULL,
    instrument VARCHAR(255) NOT NULL,
    mapped_instrument VARCHAR(255),
...
-- === Futures Funding Rate OHLC Tables ===

CREATE TABLE market.cc_futures_funding_rate_ohlc_1m (
    datetime DATETIME NOT NULL,
    market VARCHAR(255) NOT NULL,
    instrument VARCHAR(255) NOT NULL,
    mapped_instrument VARCHAR(255),
...
CREATE TABLE market.cc_futures_funding_rate_ohlc_1h (
    datetime DATETIME NOT NULL,
    market VARCHAR(255) NOT NULL,
    instrument VARCHAR(255) NOT NULL,
    mapped_instrument VARCHAR(255),
...
CREATE TABLE market.cc_futures_funding_rate_ohlc_1d (
    datetime DATETIME NOT NULL,
    market VARCHAR(255) NOT NULL,
    instrument VARCHAR(255) NOT NULL,
    mapped_instrument VARCHAR(255),
