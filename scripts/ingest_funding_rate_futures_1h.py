...
def ingest_hourly_funding_rate_data_for_instrument(
    ...
    # This is the minimum of one hour ago and the instrument's last funding rate update datetime
    effective_to_ts_datetime = one_hour_ago_utc
    if last_funding_rate_update_datetime and last_funding_rate_update_datetime < one_hour_ago_utc:
