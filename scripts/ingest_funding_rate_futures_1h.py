...
def ingest_hourly_funding_rate_data_for_instrument(
    ...
    # This is the minimum of the end of the previous hour and the instrument's last funding rate update datetime
    effective_to_ts_datetime = end_of_previous_hour
    if last_funding_rate_update_datetime and last_funding_rate_update_datetime < end_of_previous_hour:
