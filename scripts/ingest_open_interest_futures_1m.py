...
def ingest_minute_open_interest_data_for_instrument(
    ...
    # This is the minimum of one minute ago and the instrument's last open interest update datetime
    effective_to_ts_datetime = one_minute_ago_utc
    if last_open_interest_update_datetime and last_open_interest_update_datetime < one_minute_ago_utc:
