...
class MinApiPriceApiClient(CcdataBaseApiClient):
    """
    A client for interacting with the CryptoCompare (ccdata) 'Price' endpoints on min-api.
    """

    def __init__(self, api_key: str = None, base_url: str = None):
        """
        Initializes the Price API client.
        ...
        if not self.api_key:
            logger.warning("CCDATA_API_KEY is not set. Some Price API calls may fail.")
