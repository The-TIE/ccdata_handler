...
class MinApiHelperEndpointsApiClient(CcdataBaseApiClient):
    """
    A client for interacting with the CryptoCompare (ccdata) 'Helper Endpoints' on min-api.
    """

    def __init__(self, api_key: str = None, base_url: str = None):
        """
        Initializes the Helper Endpoints API client.
        ...
        if not self.api_key:
            logger.warning(
                "CCDATA_API_KEY is not set. Some Helper Endpoints API calls may fail."
            )
